...
# pipes, wedging both children. Force utf-8 with replacement instead. Guard
# each stream separately: IDE/test harnesses may swap in objects without
# reconfigure(). No-op on POSIX, where stdout is UTF-8 already.
